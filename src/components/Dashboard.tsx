...
② 강제 소제목 단락화: 정보량에 따라 본문을 3~5개의 논리적인 단락으로 나누고, 각 단락 시작마다 **'이모지 + 굵은 글씨(## 기호)'** 조합의 매력적인 소제목을 다세요. (예: "## 💡 1. 2026년, 무엇이 달라졌을까?")
...
- 🛑 [주의] '1개 단락 = 1개 슬라이드' 공식을 버리세요: 본문의 소제목 단락 수와 상관없이, 정보의 양에 비례하여 슬라이드 개수(2~7장)를 유동적으로 결정하세요. 
...
- 🍏 대본 텍스트 분리 및 다이어트 (애플 감성): 
  ...
  * 대본 작성 규칙: 공문서처럼 줄글로 쓰지 마세요. 트렌디한 IT 프레젠테이션처럼 텍스트를 최대한 다이어트하고, 한 줄당 15자 이내의 짧고 강렬한 명사형 위주로 카피를 뽑아주세요.
