...
const MASTER_PROMPT_V12 = `# 전문 정책 큐레이터 블로그 원고 작성 지침 (GEO 최적화 + 팩트 체크 V12 최종 완결판)
...
- 관공서 스타일의 제목(예: "2026년 OO시 공고 요약")은 절대 금지합니다.
- 사람들이 네이버나 AI 검색엔진에 직접 질문할 법한 '질문형/해결형' 롱테일 키워드를 사용하세요.
- [필수 조건]: 제목 전면에 독자를 후킹할 수 있는 **'구체적인 숫자(지원 금액, 혜택, 나이 등)'**를 반드시 포함하세요.
- 위 조건을 충족하는 킬링 타이틀 딱 1개만 원고 최상단에 큰 제목(#)으로 출력하세요.
